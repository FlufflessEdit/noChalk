...
const COVERS = ["#f2c14e", "#efe9dc", "#b3492f", "#3f7a3a", "#2f7d74", "#31567f", "#3a3f47", "#f7f7f2"];
const TXCOLORS = ["#1c1917", "#f5f5f4", "#57534e", "#b3271d", "#c2610f", "#b58a00", "#2f6b34", "#0f766e", "#1c56b0", "#9d174d", "#7c4a21"];
const HLCOLORS = ["#fde68a", "#bbf7d0", "#bfdbfe", "#fbcfe8", "#fed7aa", "#e5e7eb", "none"];
